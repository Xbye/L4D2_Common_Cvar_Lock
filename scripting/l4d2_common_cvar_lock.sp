...
public void OnPluginStart() 
{
    ...
    leeway_common = 30 + DEFAULT_COMMON; // 30
    leeway_min = 20 + DEFAULT_MIN;      // 10 (Some Vanilla Campaigns Change This)
    leeway_max = 30 + DEFAULT_MAX;      // 30
    leeway_mob = 40 + DEFAULT_MOB;      // 50
